...
variable "google_oauth" {
  ...
  description = "Optional Google OAuth credentials for the production Cognito managed login."
  default     = null
  sensitive   = true
}
...
variable "apple_oauth" {
  ...
  description = "Optional Sign in with Apple credentials for the production Cognito managed login."
  default     = null
  sensitive   = true
}
