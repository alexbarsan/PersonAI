...
- Cognito password policy: reduce the minimum password length from 12 to 6 characters while retaining the existing lowercase, uppercase, number, and symbol requirements. Apply deliberately to dev, then QA and production before public launch.
